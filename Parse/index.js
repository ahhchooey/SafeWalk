...
map = crimes.filter(el => {
    ...
    return ((parseFloat(el.latitude) >= 37.7879) && (parseFloat(el.latitude) <= 37.7989) && (parseFloat(el.longitude) >= -122.4055) && (parseFloat(el.longitude) < -122.3965) && el.intersection.includes('BUSH'))
})
